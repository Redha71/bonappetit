    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            @php
                ...
                $profile_data = App\Models\Partner::find($id);
            @endphp
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ !empty($profile_data->image)
                            ? url('image/partner_image/' . $profile_data->image)
                            : url('image/no_image.jpg') }}" alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('partner.profile.change.password') }}"><i
