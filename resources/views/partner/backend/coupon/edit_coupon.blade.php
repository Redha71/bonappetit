                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form id="mymenu" action="{{ route('coupon.update') }}" method="post"
                                    ...
                                    <div class="col-lg-6">
                                        <div class=" form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" id="coupon_name" name="coupon_name"
                                                aria-describedby="unique-id-here" value="{{$coupon->coupon_name}}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class=" form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="coupon_desc"
                                                aria-describedby="unique-id-here" value="{{$coupon->coupon_desc}}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class=" form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="discount"
                                                aria-describedby="unique-id-here" value="{{$coupon->discount}}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class=" form-group mb-3">
                                            ...
                                            <input class="form-control" type="date" name="validity"
                                                aria-describedby="unique-id-here" min="{{ \Carbon\Carbon::now()->format('Y-m-d')}}" value="{{$coupon->validity}}">
