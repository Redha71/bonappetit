            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Gallary</h4>
                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Partner Add Gallary</h4>

                        </div>
                        <div class="card-body p-4">
                            <form id="mymenu" action="{{ route('gallary.store') }}" method="post"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-3 mt-lg-3 ">
                                            ...
                                            <div class="mt-4 pt-3">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-primary waves-effect waves-light">Submit Images</button>
                                            </div>
