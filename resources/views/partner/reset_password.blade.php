                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt=""
                                            height="28"> <span class="logo-txt">Reset Password</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Partner Reset Password Page</h5>
                                    </div>
                                    <div class="alert alert-success text-center my-4" role="alert">
                                        Select Your New Password
                                    </div>
                                   
                                    <form class="mt-4" action="{{ route('partner.reset_password_submit') }}"
                                        method="post">
                                        @csrf
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> Bon Appetit Meal . Crafted with <i
