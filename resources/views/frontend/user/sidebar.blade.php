...
@endphp
                     <div class="border-bottom p-4">
                        <div class="osahan-user text-center">
                           <div class="osahan-user-media">
                              <img class="mb-3 rounded-pill shadow-sm mt-1" src="{{ !empty($profile_data->image)
                                 ? url('image/user_image/' . $profile_data->image)
                                 : url('image/no_image.jpg') }}" alt="gurdeep singh osahan">
                              <div class="osahan-user-media-body">
                                 <h6 class="mb-2">{{ $profile_data->name }}</h6>
                                 <p class="mb-1">{{ $profile_data->phone }}</p>
                     ...
                     <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                           <a class="nav-link active" href="{{ route('user.profile.change.password') }}" role="tab" aria-controls="orders"
