            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <img alt="Generic placeholder image" src="{{ !empty($profile_data->image)
                        ? url('image/user_image/' . $profile_data->image)
                        : url('image/no_image.jpg') }}" class="nav-osahan-pic rounded-pill"> My Account
                     </a>
                     <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                        <a class="dropdown-item" href="{{ route('user.profile.change.password') }}"><i class="icofont-food-cart"></i>Change Password</a>
