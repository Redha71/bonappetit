                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.edit.menu_detials',$item->id)}}" class="btn btn-info waves-effect waves-light">
                                        <i class="fas fa-edit"></i> </a> 
                                        <a id="delete" href="{{route('admin.delete.menu_detials',$item->id)}}" class="btn btn-danger waves-effect waves-light">
