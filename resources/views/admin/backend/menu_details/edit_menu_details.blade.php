                ...
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('admin.menu.detials.edit.submit') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class=" form-group mb-3">
                                            <label for="example-text-input" class="form-label">Partner</label>

                                            <select class="form-select" name="partner_id">
                                                <option selected="" disabled="">Select</option>
                                                @foreach ($partner as $item)
                                                    <option value="{{ $item->id }}" {{$menuDetials->partner_id ==$item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
